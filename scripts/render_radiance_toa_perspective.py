...
class RenderScript(object):
    ...
    def rendering_args(self, parser):
        ...
        parser.add_argument('--camera_height',
                            default=3,
                            type=np.float32,
                            help='(default value: %(default)s) Camera height in km')

        parser.add_argument('--camera_velocity',
                            default=45,
                            type=np.float32,
                            help='(default value: %(default)s) Camera velocity in m/sec')
    ...
    def calccenterofmass(self, droplets):
    ...
    def main(self):
        ...
        measurements = self.render(medium.get_scatterer('cloud'), rte_solver)
